    ...
    <main>
        <section class="main-section container py-5">
            <div class="shadow p-5 rounded-5">
                <form action="TherapistRegistration2.php" method="POST" enctype="multipart/form-data" class="needs-validation" id="registrationForm" novalidate>
                    ...
                    <div class="mb-3">
                        <label for="caseHandled" class="mb-1">Case Handled</label>
                        <textarea style="height: 250px; max-height: 250px;" id="caseHandled" name="caseHandled" class="form-control" required></textarea>
                        <div class="invalid-feedback">
                            Please enter a Case.
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="licenseImage" class="mb-1">License Image</label>
