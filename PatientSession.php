...
<body>
    ...
    <main class="py-0 py-sm-3">
        ...
        <section class="main-section bg-secondary-subtle py-3 py-sm-5 px-3 px-sm-5 shadow container">
            ...
            <form method="POST" action="PatientSession.php">
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                            <td><button style="width: 1100px; height: 100px; border-radius: 25px;"  
                                                                type="submit" name="BtnsessID" value="<?php echo $var_SSRec["session_id"]; ?>">
                                                                <?php echo $var_SSRec["Fname"]." ". $var_SSRec["Mname"]." ".$var_SSRec["Lname"]."<br>".
                                                                $var_SSRec["start_time"]."-". $var_SSRec["end_time"];?></button></td>
                                                </tr>
                                                    <?php
