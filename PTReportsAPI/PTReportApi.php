...
if(isset($DCodeJSON["TherapistsID"])){
    $var_PTID = $DCodeJSON["TherapistsID"];
...
JOIN
	tbl_appointment AP ON pat.patient_id = AP.patient_id
JOIN
	tbl_therapists PT ON AP.therapists_id = PT.therapist_id
WHERE 
	PT.therapist_id =".$var_PTID;
// Execute the query
