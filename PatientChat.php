...
<head>
    ...
    <title>TheraAid | Patient Chat</title>
        ...
        <section class="main-section bg-secondary-subtle py-3 py-lg-5 px-3 px-lg-5 shadow container-fluid container-lg">
            ...
            <div class="row rounded">
                ...
                <div class="col-3" id="users" style="height: 650px; overflow-y: auto;">
                    ...
                    <form method="GET" action="./PatientChat.php" class="d-flex justify-content-start align-items-center p-3 flex-column gap-2">
                    ...
                    <button type="button" class="btn btn-outline-primary btn-sm rounded-pill w-100 d-none" data-bs-target="#newChatModal" data-bs-toggle="modal">New Chat</button>
    ...
    <script>
        (async () => {
            ...
            newChatForm.addEventListener("submit", async (e) => {
                ...
                if (response.status === 200) {
                    window.location.href = `./PatientChat.php?target=${recipientID}`;
                    newChatForm.reset();
                }
